...
public class PreviousBookings extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "BookingId", "Email", "CabId", "Startloc", "Endloc", "Distance", "Amount"
            }
        ));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        UserHomepage user= new UserHomepage(loggedInmailId);
        setVisible(false);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        PrintInvoice objpi=new PrintInvoice(loggedInmailId);
        setVisible(false);
        objpi.setVisible(true);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            ...
            ptmt = connection.prepareStatement(sql);
                ptmt.setString(1, loggedInmailId);
                resultSet = ptmt.executeQuery();
                if (resultSet.next()){
                    
                      String id = resultSet.getString("BookingId");
                      String cabid = resultSet.getString("CabId");
                      String startloc = resultSet.getString("StartLoc");
                      String endloc = resultSet.getString("EndLoc");
                      int dist = resultSet.getInt("Distance");
                      int amount = resultSet.getInt("BillAmount");
                      
                      model.addRow(new Object[]{id,loggedInmailId,cabid,startloc,endloc,dist,amount});
                }
